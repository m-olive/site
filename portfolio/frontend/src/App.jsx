				...
				<div className="terminal-panels">
					...
					<div className="terminal-info-panel">
						...
						<div className="feature-list">
							...
							<span className="feature-item">/nick to set your name</span>
							<span className="feature-item">/msg &lt;username&gt; to private message</span>
							<span className="feature-item">/exit or Ctrl+C to disconnect</span>
						</div>
					</div>
				</div>
			</div>
